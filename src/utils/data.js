...
export const projectsData = [
    {
        ...
        responsive: true,
        description:  "Maintain page technical condition, increase page stability and security, and implement layout modifications."
        },
{
name: 'Pokedex (2023)',
status: "Done",
...

{
 ...
 responsive: true,
 description:  "Develop a restaurant reviews section using initial data from a JSON file. Implement a form to submit reviews and create an admin page for the management of reviews, allowing for deletion or editing."
},

{
    ...
    responsive: false,
    description:  "Develop a fullscreen, minimalistic dashboard that can be configured by the user. Include daily-use widgets that are draggable and can be placed anywhere on the screen."
   },
   {
   ...
   },    
   {
    ...
    responsive: false,
    description:  "Develop the frontend logic for an Airbnb clone app, fetching data from the backend. Implement user authorization, integrate filters and sorting for property offers, create logic for a Leaflet map, and include functionality for a review form."
   }, 
   {
   ...
   },     
   {
    ...
    additionalTechs: ['CRA', 'JWT Token', 'Rest API', 'Eslint'],
    responsive: true,
    description:  "Develop a full-stack social network app, utilizing data from the backend and enabling data writing to the backend. Implement user authorization, create a profile editing page, and deploy both the frontend and backend."
   },
]